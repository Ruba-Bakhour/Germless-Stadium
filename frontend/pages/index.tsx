  ...
  return (
    <div className="min-h-screen flex flex-col bg-blue-500">
      ...
      <header className="w-full h-16 bg-blue-500 shadow-md p-4 flex justify-between items-center">
        ...
        <button className="bg-white text-gray-900 px-4 py-2 rounded-md hover:bg-gray-300" onClick={() => navigateTo('/ControlPage')}>Control Drone</button>
        {user && (
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-12 bg-blue-100 w-full">
        {loading ? (
          ...
          <div className="w-full max-w-[1600px]">
            <h1 className="text-4xl text-gray-900 mb-12 pl-10">
            ...
            <div className="flex justify-start gap-24 pl-10">
              ...
              <button
                className="flex items-center w-[800px] h-[300px] border border-gray-300 rounded-xl shadow-lg bg-white hover:shadow-2xl transition px-10"
                onClick={() => navigateTo('/Schedule-Disinfection')} 
              >
                <div className="w-[200px] h-[200px] flex items-center justify-center border border-gray-300 rounded-lg">
                  <svg width="100" height="100" viewBox="0 0 87 86" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M14.6491 29.0869L4.23205 28.4604C11.699 8.98956 33.1374 -2.10035 54.0393 3.41345C76.3016 9.28614 89.525 31.7704 83.5746 53.6334C77.6241 75.4965 54.7532 88.4592 32.4909 82.5865C15.9614 78.2262 4.41497 64.708 2 49.086"
                      stroke="#141B34"
                      strokeWidth="2"
                      strokeLinecap="round"
